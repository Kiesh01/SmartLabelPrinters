...
function validate(){
	...
	var company=document.getElementById('Rectangle_96').value;
	var email= document.getElementById('Rectangle_95').value;
	...
	var email_check=/^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
      ...
      if(name.length < 5){
		...
		company_id : document.getElementById('Rectangle_96').value,
		email_id : document.getElementById('Rectangle_95').value,
